...
- The main process (the mother) will create N children processes.
...
- When a child finds a gem, she/he increases the bucket value by the amount of the found gemstone. Also prints the found gem (do not forget to prepend the id stamp prefix)
- The child also prints out the found gem and her/his process id.
- As soon as the end of the file is reached, they return their bucket values to the mother. (It is upto you how to return the value.)
- When all the children are done, **Mother sums up the values of all buckets and displays the result** in the following format:

**[PID:4256] Result 7250**
- The main process also prints out the elapsed time. 

# Part 2
Repeat Part 1 using threads only.
...
# Resources
[https://opensource.com/sites/default/files/gated-content/inter-process_communication_in_linux.pdf](https://opensource.com/sites/default/files/gated-content/inter-process_communication_in_linux.pdf)
